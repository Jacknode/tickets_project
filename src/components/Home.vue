  ...
  <div>
    <div class="navbar navbar-inverse">
      <div class="navbar-header">
        <a class="navbar-brand" href="javascript:;">门票后台管理系统</a>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
            ...
            <div class="sidebar-category sidebar-category-visible">
              <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                  ...
                  <li>
                    <a href="javascript:;"><i class="icon-stack2"></i> <span>门票管理</span></a>
                    <ul>
                      <!--<li>-->
                      <!--<router-link to="/home/demo">测试</router-link>-->
                      <!--</li>-->
                      <li>
                        <router-link to="/home/hotelUser">商户信息管理</router-link>
                      </li>
                      <li>
                        <router-link to="/home/gateType">门票类型管理</router-link>
                      </li>
                      <li>
                        <router-link to="/home/sceneryTicket">票种信息管理</router-link>
                      </li>
                      <li>
                        <router-link to="/home/scenicOrder">景区订单管理</router-link>
                      </li>
                    </ul>
                  </li>
                  <!-- /main -->
        ...
        <div class="content-wrapper">
          ...
          <div class="content" :class="{ 'animated': transtionActive.isActive, 'zoomInRight': transtionActive.isMove }">
            <!-- Page length options -->
            <!-- /page length options -->
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      //初始化数据
      initData(){
        this.$store.dispatch('initData',1)
          .then(()=>{
            this.$store.commit('hideLoading');
          })
        this.$store.dispatch('initData',2)
        .then(()=>{
          this.$store.commit('hideLoading');
        })
      }
